...
public class Approve extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int i=smt.executeUpdate("update busregister set status=true where email='"+mail+"'");
       
        if(i>0)
        {
        String sub="Agency Approved for Jigimigi";
        String msg="Your Travel Agency has been approved. You can login now with you entered credentials";
        Mailer.send(mail, sub, msg);
